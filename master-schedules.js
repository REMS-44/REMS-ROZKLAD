...
(()=>{
  ...
  // v2.0.64 · official elective choices for actor/theatre-director groups.
  // Source: "Витяг ПРОТОКОЛ №14 07.07.26 вибір ОК на 2026-2027".
  // These partitions make parallel elective lessons block only the students
  // who actually selected each component.
  const actorChoiceKey=value=>norm(value)
    .replace(/\s*\(вибіркова\s+ок\)\s*/g,"")
    .replace(/[’‘ʼ`]/g,"'")
    .replace(/[–—‑]/g,"-")
    .replace(/\s+/g," ")
    .trim();
  const actorNameKey=value=>norm(value).replace(/[’‘ʼ`]/g,"'").replace(/\s+/g," ").trim();
  const actorOfficialGroupRosters={
    "ТА-15":[
      "Баббо Крістіна","Бабуленко Юлія Анатоліївна","Головко Домініка Максимівна","Гребенюк Ілона Ігорівна",
      "Дворська Марина Валентинівна","Довженко Нікіта Едуардович","Жигадло Марія Олександрівна","Задорожна Адріана Олегівна",
      "Іванова Анастасія Дмитрівна","Кириленко Єлизавета Олегівна","Коваленко Софія Олегівна","Козловська Злата Валеріївна",
      "Котченко Олексій Володимирович","Левченко Ілля Олександрович","Ледовських Олена Євгенівна","Ляховець Богдан Сергійович",
      "Мазник Анастасія Сергіївна","Мазурик Анастасія Андріївна","Матвіїв Мар`яна Володимирівна","Мельник Ірина Сергіївна",
      "Недєлько Єлизавета Максимівна","Петрів Валерія Євгенівна","Пісна Софія Володимирівна","Ратнікова Валерія Юріївна",
      "Рильник Марія Дмитрівна","Синельник Владислава Олексіївна","Толстоп`ятенко Єлизавета Сергіївна","Титаренко Дар`я Олегівна"
    ],
    "ТА-25":[
      "Борисенко Вероніка Ігорівна","Борсенко Алевтина Володимирівна","Бугера Ірина Миколаївна","Бура Лілія Дмитрівна",
      "Вердієва Дамірель Ренатівна","Главачук Поліна Геннадіївна","Горак Олена Якимівна","Горбань Поліна Володимирівна",
      "Кіян Владислава Олексіївна","Кметюк Катерина Євгенівна","Кормиліцина Маргарита Віталіївна","Коханов Руслан Олександрович",
      "Лисюн Єлизавета Дмитрівна","Місюра Єлизавета Віталіївна","Олея Олександра Сергіївна","Остапчук Руслан Олександрович",
      "Рудь Єва Павлівна","Сластієнко Діана Анатоліївна","Столяренко Варвара Володимирівна","Тоірова Маргарита Назарівна",
      "Федоруца Вероніка Олександрівна","Цадо Марія Віталіївна","Швидко Домініка Олегівна","Світлична Маріанна Олександрівна",
      "Матвєєва Майя Василівна","Лісовець Марина Дмитрівна"
    ],
    "ТА-24":[
      "Климчук Вікторія Миколаївна","Козак Аліна","Лайзорик Ганна Миколаївна","Лашкул Вероніка Віталіївна",
      "Левенко Владислава Володимирівна","Найда Крістіна Володимирівна","Отзель Катерина Сергіївна","Сопілко Денис Леонідович",
      "Стрільчук Ольга Анатоліївна","Тарганчук Ольга Сергіївна","Фурманова Мар`яна Олександрівна","Садова Олександра Вячеславівна",
      "Оніщук Іванна Дмитрівна","Кулієв Ількін Ельшан Огли","Кулик Анна Олегівна","Краснобай Ангеліна Олексіївна",
      "Колесник Маргарита Андріївна","Давидов Павло Павлович","Гусаревич Дарія Сергіївна","Баранова Вікторія Вікторівна"
    ],
    "ТА-23":[
      "Антонов Микола Андрійович","Білецька Маргарита Олегівна","Дригола Єва Сергіївна","Заморока Анастасія Вікторівна",
      "Канівець Катерина Юріївна","Костарнов Даніїл Артемович","Панкєєв Даниїл Андрійович","Рибінська Олександра Андріївна",
      "Червонюк Анастасія Сергіївна","Умрихін Лілія Володимирівна","Процевська Олександра Володимирівна","Мокрій Назарій Володимирович",
      "Мамиконян Ярослав Юрійович","Лисенко Дар`я Олександрівна","Ковбасюк Дар`я Олександрівна"
    ],
    "ТА-53":[
      "Вітер Мальва Олексіївна","Жолоб Вікторія Миколаївна","Іващенко Даниіл Олександрович","Корочанська Анна Олександрівна",
      "Курило Софія Сергіївна","Савенко Андрій Артемович","Чмихало Діана Сергіївна","Червінський Іван Русланович",
      "Рижак Данііл Сергійович","Матющенко Марина Сергіївна"
    ],
    "ТР-33":[
      "Беспрозванна Марина Дмитрівна","Вишневецька Діана Юріївна","Гавриленко Ганна Максимівна","Денисюк Софія Мар`янівна",
      "Дьожина Ілона Вадимівна","Золотоцька Марина Володимирівна","Комісарова Єлизавета Костянтинівна","Решитько Мілана Вікторівна",
      "Тавакова Вікторія Дмитрівна","Хармфул Марі Петрівна","Шаталов Антон Русланович","Пузирьова Валерія Володимирівна",
      "Велигонь Дар`я Сергіївна"
    ]
  };
  const actorElectiveAudiences=[
    {group:"ТА-15",discipline:"Емоційний інтелект",names:["Дворська Марина Валентинівна","Іванова Анастасія Дмитрівна","Ратнікова Валерія Юріївна"]},
    {group:"ТА-15",discipline:"Психологія",exclude:["Дворська Марина Валентинівна","Іванова Анастасія Дмитрівна","Ратнікова Валерія Юріївна"]},
    {group:"ТА-25",discipline:"Штучний інтелект та креатив",names:["Кіян Владислава Олексіївна","Сластієнко Діана Анатоліївна","Швидко Домініка Олегівна"]},
    {group:"ТА-25",discipline:"Психологія",exclude:["Кіян Владислава Олексіївна","Сластієнко Діана Анатоліївна","Швидко Домініка Олегівна"]},
    {group:"ТА-24",discipline:"Цифровий сторітелінг",names:["Климчук Вікторія Миколаївна","Фурманова Мар`яна Олександрівна"]},
    {group:"ТА-24",discipline:"Сценічний спів",exclude:["Климчук Вікторія Миколаївна","Фурманова Мар`яна Олександрівна"]},
    {group:"ТА-23",discipline:"Self-менеджмент актора в кіно",exclude:["Антонов Микола Андрійович","Дригола Єва Сергіївна","Рибінська Олександра Андріївна"]},
    {group:"ТА-23",discipline:"Акторський знімальний практикум",exclude:["Антонов Микола Андрійович"]},
    {group:"ТА-23",discipline:"Дубляж та радіомовлення",exclude:["Рибінська Олександра Андріївна"]},
    {group:"ТА-23",discipline:"Організація знімального процесу",names:["Антонов Микола Андрійович","Рибінська Олександра Андріївна"]},
    {group:"ТА-23",discipline:"Режисура фізичного театру",names:["Антонов Микола Андрійович","Дригола Єва Сергіївна","Рибінська Олександра Андріївна"]},
    {group:"ТА-53",discipline:"Self-менеджмент актора в кіно",exclude:["Жолоб Вікторія Миколаївна"]},
    {group:"ТА-53",discipline:"Організація знімального процесу",names:["Жолоб Вікторія Миколаївна"]},
    {group:"ТР-33",discipline:"Self-менеджмент актора в кіно",names:["Денисюк Софія Мар`янівна","Дьожина Ілона Вадимівна","Комісарова Єлизавета Костянтинівна","Тавакова Вікторія Дмитрівна","Шаталов Антон Русланович","Пузирьова Валерія Володимирівна","Велигонь Дар`я Сергіївна"]},
    {group:"ТР-33",discipline:"Акторський знімальний практикум",names:["Гавриленко Ганна Максимівна","Комісарова Єлизавета Костянтинівна","Хармфул Марі Петрівна"]},
    {group:"ТР-33",discipline:"Дубляж та радіомовлення",names:["Беспрозванна Марина Дмитрівна","Вишневецька Діана Юріївна","Дьожина Ілона Вадимівна","Золотоцька Марина Володимирівна","Решитько Мілана Вікторівна","Шаталов Антон Русланович"]},
    {group:"ТР-33",discipline:"Організація знімального процесу",names:["Беспрозванна Марина Дмитрівна","Вишневецька Діана Юріївна","Гавриленко Ганна Максимівна","Денисюк Софія Мар`янівна","Золотоцька Марина Володимирівна","Решитько Мілана Вікторівна","Тавакова Вікторія Дмитрівна","Хармфул Марі Петрівна","Пузирьова Валерія Володимирівна","Велигонь Дар`я Сергіївна"]}
  ];
  function scheduleGroupMatchesActorChoice(item,group){
    const groups=[item?.group,...(Array.isArray(item?.audienceGroups)?item.audienceGroups:[])].filter(Boolean);
    return groups.some(code=>norm(code)===norm(group));
  }
  actorElectiveAudiences.forEach(choice=>{
    const officialRoster=actorOfficialGroupRosters[choice.group]||[];
    const excluded=new Set((choice.exclude||[]).map(actorNameKey));
    const officialNames=choice.names?.length?[...choice.names]:officialRoster.filter(name=>!excluded.has(actorNameKey(name)));
    const groupStudents=(state.students||[]).filter(st=>st.status!=="archived"&&norm(st.group)===norm(choice.group));
    const idByName=new Map(groupStudents.map(st=>[actorNameKey(st.name),Number(st.id)]));
    const studentIds=officialNames.map(name=>idByName.get(actorNameKey(name))).filter(Boolean);
    state.schedule.filter(item=>scheduleGroupMatchesActorChoice(item,choice.group)&&actorChoiceKey(item.discipline)===actorChoiceKey(choice.discipline)).forEach(item=>{
      const prior=Array.isArray(item.audiencePartitions)?item.audiencePartitions.filter(p=>norm(p?.group)!==norm(choice.group)):[];
      item.audiencePartitions=[...prior,{group:choice.group,mode:"selected",studentIds:[...new Set(studentIds)]}];
      item.audiencePartitionsSource="documented_actor_elective_choices_2026_07_07";
      item.audienceStudentIds=[...new Set(item.audiencePartitions.flatMap(p=>p.studentIds||[]).map(Number).filter(Boolean))];
      item.audienceStudentNamesOfficialByGroup={...(item.audienceStudentNamesOfficialByGroup||{}),[choice.group]:[...officialNames]};
      item.audienceStudentNamesOfficial=[...new Set(Object.values(item.audienceStudentNamesOfficialByGroup).flat())];
      item.audienceMode="selected";
      item.coverage="Вибрані студенти";
      item.sourceAudienceFile="Витяг ПРОТОКОЛ №14 (07.07.26) вибір ОК на 2026-2027";
    });
  });
  state.actorElectiveRosterVersion="2026-09-17-protocol14-v2";
